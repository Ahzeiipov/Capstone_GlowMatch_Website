...
if(isset($_POST['submit_signup'])){
  ...
  $query = $con->prepare("INSERT INTO user (name, email, password) VALUES (?, ?, ?)");
  $query->bind_param("sss", $name, $email, $password);
  $result = $query->execute();

  if($result){
    $_SESSION['message'] = 'User Registered Successfully.';
    header("Location: /project_capstone_skincare/GlowMatch-front/pages/homepage/homepage.php");
    exit();
  }else{
...
if(isset($_POST['submit_login'])){
  ...
  $query = $con->prepare("SELECT password FROM user WHERE email=?");
