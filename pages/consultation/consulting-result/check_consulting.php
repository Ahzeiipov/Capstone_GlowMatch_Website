<?php
 ...
 if ($row['count'] > 0) {
     header("Location: /php/GlowMatch/pages/consultation/consulting-result/consulting-result.php");
 } else {
     header("Location: /php/GlowMatch/screen/wellcome_page/consulting_wellcome_page.php");
 }
 exit();
 ?>